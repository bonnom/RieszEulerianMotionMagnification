...
class RieszPyramid:
    ...
    def apply_riesz_filters(self, octave):
        ...
        kernel_x  = np.asarray([[-0.12,0,0.12],[-0.34, 0, 0.34],[-0.12,0,0.12]])
...
if __name__ == "__main__":
    ...
    magnify_motion("baby.mp4", "baby_amplified_old_riesz.mp4", 
                   low_cutoff=0.1, high_cutoff=0.4, amplification=10, levels=5,
